...
( function( document ) {
    ...
    document.addEventListener( "impress:init", function( event ) {
        ...
        gc.addEventListener( document, "keydown", function( event ) {
            window.console.log( "keydown:event.key:" + event.key + ":" + event.keyCode + ":");
            ...
            if ( event.key === "p" ) {
                var snum = 1
                var currentPage = document.URL.substring( document.URL.search( '#/step-' ), document.URL.length );
                console.log('KeyP is clicked:' + currentPage + ":");
...
( function( document, window ) {
    ...
    var impressConsole = window.impressConsole = function( rootId ) {
        ...
        var spaceHandler = function() {
            console.log('Inside spaceHandler');
            var notes = consoleWindow.document.getElementById( 'notes' );
        ...
        var playAudioHandler = function() {
            ...
            var audio = consoleWindow.document.getElementById("audio" + snum);
            if(audio) {
                audio.play();
            }
        };
        ...
        var open = function() {
            ...
            if ( consoleWindow && !consoleWindow.closed ) {
                ...
                // 34: pg down, 39: right, 40: down, 10, 13: carriage return
                registerKeyEvent( [ 10, 13, 34, 39, 40 , 78 ], window.impress().next );
                ...
                // 80: P, play audio file
                registerKeyEvent( [ 80 ], playAudioHandler );
        ...
        var _init = function( cssConsole, cssIframe ) {
            ...
            //Open speaker console when they press 'q'  81
            registerKeyEvent( [ 81 ], open, window );
    ...
    document.addEventListener( 'impress:init', function( event ) {
        ...
        triggerEvent( document, 'impress:help:add',
                        { command: 'Q', text: 'Presenter console', row: 10 } );
    } );
